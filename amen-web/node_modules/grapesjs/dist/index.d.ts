...
export declare class DataSource<DRProps extends DataRecordProps = DataRecordProps> extends Model<DataSourceType<DRProps>> {
	...
	isRecordIndex(id: string | number): boolean;
	/**
	...
	getContext(): Record<string, Partial<DRProps>>;
	/**
...
export declare class DataRecords<T extends DataRecordProps = DataRecordProps> extends Collection<DataRecord<T>> {
	...
	isIndexKey(id: string | number): boolean;
...
export declare class Frames extends ModuleCollection<Frame> {
	...
	initRefs(): void;
	toJSON(opts?: Parameters<Frame["toJSON"]>[0]): any[];
	itemLoaded(): void;
	listenToLoad(): void;
...
Component> {
	...
	updateFrameRefs(model: Component, frame?: Frame): void;
...
export declare class Page extends Model<PagePropertiesDefined> {
	...
	em: EditorModel;
	constructor(props: PageProperties, opts?: {
		em?: EditorModel;
...
declare class FrameView extends ModuleView<Frame, HTMLIFrameElement> {
	...
	getComponentView(component: any): {
		dt: ComponentStackItem<Component, ComponentView<Component>>[];
		view: any;
	};
	getRect(): DOMRect;
	/**
	...
	renderRefComponent(rootView: ComponentView): void;
...
export declare class Frame extends ModuleModel<CanvasModule> {
	...
	updateComponentFrame(component: Component): void;
	emitComponentAdd(component: Component, opts?: Record<string, any>): void;
...
declare class LayerManager extends Module<LayerManagerConfig> {
	 ...
	 */
	getName(component: Component): string;
	/**
...
declare class CommandSelectComponent extends CommandAbstract<SelectComponentCommandOptions, SelectComponentCommandStopOptions> {
	[key: string]: any;
	...
	run(ed: any, s?: any, opts?: SelectComponentCommandOptions): void;
	stop(ed?: any, s?: any, opts?: SelectComponentCommandStopOptions): void;
}
...
export declare class Property<T extends PropertyPropsCustom = PropertyPropsCustom> extends Model<T> {
	 ...
	 */
	isFull(): boolean;
	__parseValue(value: string, opts: any): Partial<PropertyPropsCustom>;
	__parseValueCustom(value: string, parse: () => Partial<T>): Partial<PropertyPropsCustom>;
...
export declare class PropertyStack extends PropertyComposite<PropertyStackProps> {
	...
	__parseValue(value: string): Partial<PropertyPropsCustom>;
...
export declare class DataSourceManager extends ItemManagerModule<DataSourcesConfig & ModuleConfig, DataSources> {
	...
	private getValueFromDataSources;
	/**
